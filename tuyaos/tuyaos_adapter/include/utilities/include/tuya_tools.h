 ...
 */
UCHAR_T tuya_asc2hex(char asccode);
 ...
 * @return none
 */
void tuya_ascs2hex(UCHAR_T *hex, UCHAR_T *ascs, int srclen);
 ...
 */
void tuya_hex2str(UCHAR_T *str, UCHAR_T *hex, int hexlen);
 ...
 * @return none 
 */
void tuya_byte_sort(UCHAR_T is_ascend, UCHAR_T *buf, int len);
