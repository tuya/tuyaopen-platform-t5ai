...
#if defined(ENABLE_EXT_RAM) && (ENABLE_EXT_RAM==1)
    OPERATE_RET         (*thread_create_in_psram)   (TKL_THREAD_HANDLE* thread, const char* name, const uint32_t stack_size, const uint32_t priority, const THREAD_FUNC_T func, void* const arg);
#endif
