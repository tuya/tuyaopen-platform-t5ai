...
static void dwt_command_usage(void)
{
    ...
    os_printf("xdwtdr data_address data_address_limit\r\n");
    ...
    os_printf("xdwtdd data_address data_value\r\n");
    os_printf("     data_address: watch this data address, hex format\r\n");
...
static const struct cli_command s_dwt_commands[] = {
    {"xdwti", "dwt instruction_addr", dwti_Command},
    {"xdwtd", "dwtd r/w/b data_address", dwtd_Command},
    {"xdwtdr", "dwtdr data_address data_address_limit", dwtdr_Command},
    {"xdwtdd", "dwtdd data_address data_value", dwtdd_Command},
};
