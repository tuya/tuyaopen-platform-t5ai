...
def pack_all(config_dir, aes_key=None):
    if config_dir != None:
    ...
    if pbl2 != None:
        if s.secureboot_en:
            bl1_sign('sign', s.bl2_root_key_type, s.bl2_root_privkey, s.bl2_root_pubkey, None, pbl2.bin_name, pbl2.static_addr, pbl2.load_addr, 'primary_manifest.bin')
            ...
            if (boot_ota == True):
                ...
                bl1_sign('sign', s.bl2_root_key_type, s.bl2_root_privkey, s.bl2_root_pubkey, None, pbl2_B.bin_name, pbl2_B.static_addr, pbl2_B.load_addr, 'secondary_manifest.bin')
        ...
        bl2_sign('sign', s.bl2_root_key_type, s.bl2_root_privkey, s.bl2_root_pubkey, None, 'primary_all.bin', pall.vir_sign_size, '0.0.1', o.get_app_security_counter(), 'primary_all_signed.bin', 'app_hash.json')
