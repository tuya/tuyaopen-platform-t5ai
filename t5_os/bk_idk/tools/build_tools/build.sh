...
# Modified by TUYA Start
	if [ "x${ARMINO_SOC}" == "xbk7258" ]; then
		echo -e "\033[1;31m build T5 \033[0m"
	elif [ "x${ARMINO_SOC}" == "xbk7258_cp1" ]; then
		echo -e "\033[1;31m build T5_CPU1 \033[0m"
	elif [ "x${ARMINO_SOC}" == "xbk7258_cp2" ]; then
		echo -e "\033[1;31m build T5_CPU2 \033[0m"
	else
		echo -e "\033[1;31m build ${ARMINO_SOC} \033[0m"
	fi
