...
static void sys_drv_module_power_ctrl_ptr(unsigned int module, uint32_t power_state)
{
...
static uint32_t sys_drv_module_power_state_get_ptr(unsigned int module)
{
