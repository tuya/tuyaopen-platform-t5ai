...
/* TODO: PM_CPU_FRQ_320M and similar macros should be refactored just like CPU_FREQ_LEVEL_x
 *       for the soc maybe does not support the 320MHz.
 */
...
{
    /*TODO set bk7239 saradc ananlog reg config*/
}
...
{
	return sys_ll_get_ana_reg5_en_ram();
}
