...
#define DMA0_NSEC_INTERRUPT_CTRL_BIT   (1 << SYS_CPU0_INT_0_31_EN_CPU0_DMA0_NSEC_INTR_EN_POS)
...
#define TIMER_INTERRUPT_CTRL_BIT       (1 << SYS_CPU0_INT_0_31_EN_CPU0_TIMER0_INT_EN_POS)
...
#define LCD_INTERRUPT_CTRL_BIT         (1 << SYS_CPU0_INT_0_31_EN_CPU0_LCD_DISPLAY_INT_EN_POS)
#define DMA2D_INTERRUPT_CTRL_BIT       (1 << SYS_CPU0_INT_0_31_EN_CPU0_DMA2D_INT_EN_POS)
...
#define DMA1_SEC_INTERRUPT_CTRL_BIT    (1 << SYS_CPU0_INT_32_63_EN_CPU0_DMA1_SEC_INT_EN_POS)
#define DMA1_NSEC_INTERRUPT_CTRL_BIT   (1 << SYS_CPU0_INT_32_63_EN_CPU0_DMA1_NSEC_INT_EN_POS)
...
#define LOW_POWER_DPLL_STABILITY_DELAY_TIME                  (0.29) // 0.19ms(hardware need at least 180us,because making the precise it use 290us,it will additional add 6us or 2us(external) )
#define LOW_POWER_RESTORE_DELAY_TIME_HARDWARE                (0.75) //0.6ms,cpu 60M 0.7ms
...
#define PM_DEFAULT_LOW_VOLTAGE_WAKEUP1_DELAY 8
#define PM_DEFAULT_LOW_VOLTAGE_WAKEUP2_DELAY 8
#define PM_DEFAULT_LOW_VOLTAGE_WAKEUP3_DELAY 3

/*current used wakeup delay*/
#define PM_CURRENT_LOW_VOLTAGE_WAKEUP1_DELAY 0xb
#define PM_CURRENT_LOW_VOLTAGE_WAKEUP2_DELAY 0xb
