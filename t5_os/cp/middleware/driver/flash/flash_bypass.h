...
#define FLASH_BYPASS_LOGV(...) BK_LOGV(FLASH_BYPASS_TAG, ##__VA_ARGS__)
...
#define FLASH_BYPASS_RAWV(...) BK_RAW_LOGV(FLASH_BYPASS_TAG, ##__VA_ARGS__)
...
#define FLASH_BYPASS_OTP_READ_RETRY_MAX        (5)      // Modified by TUYA
#define FLASH_BYPASS_OTP_EARSE_RETRY_MAX       (3)
#define FLASH_BYPASS_OTP_WRITE_RETRY_MAX       (10)     // Modified by TUYA
