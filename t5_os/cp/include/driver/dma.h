 ...
 * @brief     Register the interrupt service routine for DMA channel
 *
 * This API regist dma error isr callback function.
 *
 * @param id DMA channel
 ...
 *
 * @param id DMA channel
 * @param dma_arg_isr DMA half finish, finish, bus error callback and  pointer variable
 *
 * @return
 *    - BK_OK: succeed
 *    - others: other errors.
 ...
 *
 * @param id DMA channel
 * @param dma_arg_isr DMA half finish callback and pointer variable
 *
 * @return
 *    - BK_OK: succeed
 *    - others: other errors.
 ...
 *
 * @param id DMA channel
 * @param dma_arg_isr DMA finish callback and pointer variable
 *
 * @return
 *    - BK_OK: succeed
 *    - others: other errors.
 ...
 *
 * @param id DMA channel
 * @param dma_arg_isr DMA bus error callback and pointer variable
 *
 * @return
 *    - BK_OK: succeed
 *    - others: other errors.
