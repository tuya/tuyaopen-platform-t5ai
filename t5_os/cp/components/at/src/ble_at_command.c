...
static uint8_t s_ethermind_service_type = 0; //0 timer send; 1 send when last completed
...
int ble_unregister_service_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_create_bond_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);

#if 1
int set_ble_device_name_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int get_ble_device_name_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_set_adv_param_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_set_adv_data_raw_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_set_adv_data_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_set_scan_rsp_data_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_set_scan_rsp_data_raw_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_set_adv_enable_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_set_scan_param_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_set_scan_enable_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_set_per_adv_param_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_set_per_adv_data_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
int ble_set_per_adv_enable_handle_gap(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
#endif
...
const at_command_t ble_at_cmd_table[] = {
    ...
    {27, "SETMAXMTU", 1, "set att maximal mtu", ble_set_max_mtu_handle},
    ...
    {38, "STABILITYTEST", 0, "stability test", ble_stability_test_handle},

/*************************add for new at cmd format*****************************/
    {39, "ATVERSION", 0, "set at cmd version", ble_set_atcmd_version_handle},

#if 1
#ifdef CONFIG_BT
    {0, "BLENAME", 1, "return ble name", set_ble_name_handle},
    {1, "BLENAME?", 1, "return ble name", get_ble_name_handle},
#else
    {0, "BLENAME", 0, "return ble name", set_ble_name_handle},
    {1, "BLENAME?", 0, "return ble name", get_ble_name_handle},
#endif
    {2, "ADVPARAM", 1, "help", ble_set_adv_param_handle},
    {3, "ADVDATA", 1, "set adv data", ble_set_adv_data_handle},
    {4, "PERADVDATA", 1, "set perodic adv data", ble_set_per_adv_data_handle},
    {5, "SCANRSPDATA", 1, "set scan response data", ble_set_scan_rsp_data_handle},
    {6, "ADVENABLE", 1, "set adv enable(1)/disable(0)", ble_set_adv_enable_handle},
    {7, "SCANPARAM", 1, "set scan param", ble_set_scan_param_handle},
    {8, "SCANENABLE", 1, "set scan enable(1)/disable(0)", ble_set_scan_enable_handle},

    {12, "CONNPARAM", 1, "update connection param", ble_update_conn_param_handle},

    {13, "CONNECTSTATE?", 0, "get connection state", ble_get_conn_state_handle},
#ifdef CONFIG_BT
    {14, "LOCALADDR?", 1, "get ble local address", ble_get_local_addr_handle},
#else
    {14, "LOCALADDR?", 0, "get ble local address", ble_get_local_addr_handle},
#endif
    {15, "LOCALADDR", 0, "set ble local address", ble_set_local_addr_handle},

    {17, "PHY?", 1, "read current tx/rx phy", ble_read_phy_handle},
    {18, "PHY", 1, "set current tx/rx phy", ble_set_phy_handle},
    ...
    {27, "MAXMTU", 1, "set att maximal mtu", ble_set_max_mtu_handle},

/******************************************************************************/

    {40, "UNREGISTERSERVICE", 1, "unregister a service", ble_unregister_service_handle},
    {41, "BOND", 1, "Create Bluetooth Bonding", ble_create_bond_handle},

//#endif
#else
    {0, "BLENAME", 0, "return ble name", set_ble_device_name_handle_gap},
    {1, "BLENAME?", 0, "return ble name", get_ble_device_name_handle_gap},
    {2, "ADVPARAM", 1, "help", ble_set_adv_param_handle_gap},
    {3, "ADVDATARAW", 1, "set adv data raw", ble_set_adv_data_raw_handle_gap},
    {4, "ADVDATA", 1, "set adv data", ble_set_adv_data_handle_gap},
    {5, "SCANRSPDATARAW", 1, "set scan response data raw", ble_set_scan_rsp_data_raw_handle_gap},
    {6, "SCANRSPDATA", 1, "set scan response data", ble_set_scan_rsp_data_handle_gap},
    {7, "ADVENABLE", 1, "set adv enable(1)/disable(0)", ble_set_adv_enable_handle_gap},

    {8, "SCANPARAM", 1, "set scan param", ble_set_scan_param_handle_gap},
    {9, "SCANENABLE", 1, "set scan enable(1)/disable(0)", ble_set_scan_enable_handle_gap},

    {10, "PERADVPARAM", 1, "set perodic adv param", ble_set_per_adv_param_handle_gap},
    {11, "PERADVDATA", 1, "set perodic adv data", ble_set_per_adv_data_handle_gap},
    {12, "PERADVENABLE", 1, "set perodic adv enable(1)/disable(0)", ble_set_per_adv_enable_handle_gap},
#endif
};
...
int set_ble_name_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    {
        return set_ble_device_name_handle_gap(pcWriteBuffer, xWriteBufferLen, argc, argv);
...
int get_ble_name_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    {
        return get_ble_device_name_handle_gap(pcWriteBuffer, xWriteBufferLen, argc, argv);
...
int ble_set_adv_param_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    else
    {
        ...
        {
            return ble_set_per_adv_param_handle_gap(pcWriteBuffer, xWriteBufferLen, argc, argv);
        }
        else
        {
            return ble_set_adv_param_handle_gap(pcWriteBuffer, xWriteBufferLen, argc, argv);
        }
...
int ble_set_adv_data_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    {
        return ble_set_adv_data_raw_handle_gap(pcWriteBuffer, xWriteBufferLen, argc, argv);
...
int ble_set_per_adv_data_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    {
        return ble_set_per_adv_data_handle_gap(pcWriteBuffer, xWriteBufferLen, argc, argv);
    }
...
int ble_set_scan_rsp_data_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    {
        return ble_set_scan_rsp_data_raw_handle_gap(pcWriteBuffer, xWriteBufferLen, argc, argv);
...
int ble_set_adv_enable_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    else
    {
        ...
        {
            return ble_set_per_adv_enable_handle_gap(pcWriteBuffer, xWriteBufferLen, argc, argv);
        }
        else
        {
            return ble_set_adv_enable_handle_gap(pcWriteBuffer, xWriteBufferLen, argc, argv);
        }
...
int ble_set_scan_param_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    {
        return ble_set_scan_param_handle_gap(pcWriteBuffer, xWriteBufferLen, argc, argv);
...
int ble_set_scan_enable_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    {
        return ble_set_scan_enable_handle_gap(pcWriteBuffer, xWriteBufferLen, argc, argv);
...
static void ble_connect_sdp_comm_callback(MASTER_COMMON_TYPE type, uint8_t conidx, void *param)
{
...
int ble_get_conn_state_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    else
    {
        ...
        {
            sprintf(pcWriteBuffer, "%s:%s\r\n", AT_CMDRSP_HEAD, "BLE_DISCONNECTED");
        }
...
int ble_update_mtu_2_max_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    if(bk_ble_get_host_stack_type() != BK_BLE_HOST_STACK_TYPE_ETHERMIND)
    {
        ...
        if (ble_at_cmd_table[24].is_sync_cmd)
        {
            err = rtos_init_semaphore(&ble_at_cmd_sema, 1);
            if (err != kNoErr)
            {
...
int ble_tx_test_param_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    {
        LOGE("%s len %d must less than current_mtu - 3 %d!!!\n", __func__, len, s_ethermind_current_mtu - 3);
        err = kParamErr;
        goto error;
    }
...
int ble_set_max_mtu_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
	...
	if (ble_at_cmd_table[27].is_sync_cmd)
	{
		err = rtos_init_semaphore(&ble_at_cmd_sema, 1);
		if(err != kNoErr){
			goto error;
...
int ble_att_write_handle(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
   ...
   // int scanf_ret = 0;
    ...
    err = bk_ble_gattc_write_char(ble_at_get_gatt_ctx_handle()->gattc_if, conn_handle, attr_handle, data_count, send_value, BK_GATT_WRITE_TYPE_RSP, BK_GATT_AUTH_REQ_NONE);
