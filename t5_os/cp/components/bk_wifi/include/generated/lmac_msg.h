...
enum mm_msg_tag
{
    ...
    ///set default AC Request.  msgid:134
...
void rwnxl_wakeup();
bool rwnxl_check_low_voltage_status();
...
int macif_get_rxl_payload_offset();
int macif_max_sg_size();
