...
/// The frame is from controller interface
#define TXU_CTRL_IF_DATA                CO_BIT(19)
/// The frame need re-config policy_tbl.maccntrlinfo2
#define TXU_CNTRL_PT_RERTY              CO_BIT(20)
//#endif
