...
#define WIFI_INT_LOW32_BIT      (WIFI_MODEM_EN | WIFI_MODEM_RC_EN | WIFI_MAC_TX_RX_TIMER_INT_BIT)
#define WIFI_INT_HIGH32_BIT     (WIFI_MAC_TX_RX_MISC_INT_BIT | WIFI_MAC_RX_TRIGGER_INT_BIT | WIFI_MAC_TX_TRIGGER_INT_BIT |\
                                WIFI_MAC_PORT_TRIGGER_INT_BIT | WIFI_MAC_GEN_INT_BIT | WIFI_HSU_INTERRUPT_CTRL_BIT | WIFI_MAC_WAKEUP_INT_BIT)
...
#if CONFIG_PM_V2 && CONFIG_STA_PS && (CONFIG_SOC_BK7256XX || CONFIG_SOC_BK7236XX || CONFIG_SOC_BK7239XX || CONFIG_SOC_BK7286XX)
	if (!ate_is_enabled())
	{
		rwnxl_sleep();
