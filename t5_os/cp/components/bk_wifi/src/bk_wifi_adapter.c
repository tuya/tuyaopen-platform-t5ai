...
static bk_err_t gpio_dev_map_wrapper( uint32_t gpio_id, uint32_t dev)
{
    return gpio_dev_map(gpio_id,dev);
}
...
__attribute__((section(".dtcm_sec_data "))) wifi_os_funcs_t g_wifi_os_funcs = {
	...
	._gpio_dev_unprotect_unmap = gpio_dev_unmap_wrapper,
	._gpio_dev_unprotect_map = gpio_dev_map_wrapper,
