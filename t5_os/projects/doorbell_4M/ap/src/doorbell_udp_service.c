...
bk_err_t doorbell_udp_service_init(void)
{
    ...
    db_udp_service->img_channel = doorbell_transmission_malloc(0, DOORBELL_UDP_NETWORK_MAX_SIZE);
    ...
    db_udp_service->aud_channel = doorbell_transmission_malloc(DOORBELL_UDP_NETWORK_MAX_SIZE, DOORBELL_UDP_NETWORK_MAX_SIZE);
