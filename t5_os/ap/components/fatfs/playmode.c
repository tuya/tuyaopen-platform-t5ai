...
#if CONFIG_SDCARD && CONFIG_USBH_MSC
#include "ff.h"
...
uint16 mp3queuecount = 0; //��MP3�ļ����ļ�����Ŀ
uint16 mp3filecount = 0;//	MP3�����ܵ���Ŀ
FATFS Fatfs_buf;
FIL fsFD;
DIR_QUEUE *point_front;//��ͷָ��
DIR_QUEUE *point_rear;//��βָ��
...
static uint32 initfatsystem(uint8 type)
{
    ...
    {
        //dir_buf=(DIR_QUEUE*)jmalloc(MAX_DIR_SUPPORT*sizeof(DIR_QUEUE),0);//���֧�ֵ��ļ���
        //if(!dir_buf)
        //	return -1;
        dir_buf = &g_dirbuf[0];
