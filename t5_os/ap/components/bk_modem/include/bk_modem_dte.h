...
extern uint32_t bk_modem_dte_send_data(uint32_t data_length, uint8_t *data, enum bk_modem_ppp_mode_e ppp_mode);
extern bk_err_t bk_modem_dte_recv_data(uint32_t data_length, uint8_t *data);
