...
#define SENSOR_I2C_READ(reg, value)\
    do {\
        dvp_camera_i2c_read_uint8((GC2145_WRITE_ADDRESS >> 1), reg, value);\
    } while (0)
...
#endif
    {0xfe, 0x00},
    {0x24, 0xff},//[7:6] drv_low_data [5:4] sync_drv[3:2] drv_high_data[1:0] pclk_drv
    {0xfe, 0x00},
};
...
*/
const uint8_t sensor_gc2145_1600_1200_table[][2] =
{
    //pclk=72m,fps=21fps
    {0xfe, 0x00},
    //{0xfe, 0x00},
...
const uint8_t sensor_gc2145_1600_1200_10fps_table[][2] =
{
    //////////////frame rate 50Hz////////////////////////////////////////////////////
    {0xfe, 0x00},
    {0x05, 0x01},
...
int gc2145_set_ppi(media_ppi_t ppi)
{
    uint32_t size, i;
    int ret = -1;
    ...
    switch (ppi)
    {
        ...
        case PPI_1600X1200:
        {
            size = sizeof(sensor_gc2145_1600_1200_table) / 2;
...
int gc2145_set_fps(frame_fps_t fps)
{
    ...
    if (width == 0x0640)
    {
        size = sizeof(sensor_gc2145_1600_1200_10fps_table) / 2;
