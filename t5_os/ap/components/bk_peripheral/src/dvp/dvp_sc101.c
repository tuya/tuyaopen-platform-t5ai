...
#define SC101_WRITE_ADDRESS (0xD0)
#define SC101_READ_ADDRESS (0xD1)

#define CHIP_ID_ADDR_HB (0xF7)
#define CHIP_ID_ADDR_LB (0xF8)
#define CHIP_ID_VAL_HB (0xDA)
#define CHIP_ID_VAL_LB (0x4A)
...
#define SENSOR_I2C_READ(reg, value)\
    do {\
        dvp_camera_i2c_read_uint8((SC101_WRITE_ADDRESS >> 1), reg, value);\
    } while (0)
...
const uint8_t sensor_SC101_1280_720_30fps_table[][2] =
{
    {0xf0, 0x31},
    {0x03, 0x01},
    {0xf0, 0x31},
...
int SC101_set_ppi(media_ppi_t ppi)
{
    return 0;
}


int SC101_set_fps(frame_fps_t fps)
{
    ...
    switch (fps)
    {
        ...
        case FPS20:
        {
            size = sizeof(sensor_SC101_1280_720_20fps_table) / 2;
        ...
        case FPS30:
        {
            size = sizeof(sensor_SC101_1280_720_30fps_table) / 2;
