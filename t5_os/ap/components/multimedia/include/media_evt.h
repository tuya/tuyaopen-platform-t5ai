...
typedef enum
{
	...
	EVENT_AUD_VOC_ASR_START_REQ,		/**< voc asr start */
	EVENT_AUD_VOC_ASR_STOP_REQ, 		/**< voc asr stop  */
	/* UAC op */
	...
	EVENT_CAM_OPEN_IND = (CAM_EVENT << MEDIA_EVT_BIT),
	EVENT_CAM_CLOSE_IND,
	...
	EVENT_CAM_SWITCH_MAIN_IND,
    EVENT_CAM_GET_MAIN_STREAM_IND,

	EVENT_IMG_OPEN_IND = (LCD_EVENT << MEDIA_EVT_BIT),
	EVENT_IMG_CLOSE_IND,
	EVENT_IMG_ROTATE_IND,
	EVENT_IMG_SCALE_IND,
	EVENT_IMG_BLEND_OPEN_IND,
	EVENT_IMG_BLEND_IND,
	EVENT_IMG_BLEND_CLOSE_IND,
	...
	EVENT_SAVE_FRAME_DATA_IND,
	EVENT_LCD_DISP_OPEN_IND,
	...
	EVENT_YUV_ROTATE_INIT_NOTIFY,
	EVENT_YUV_ROTATE_DEINIT_NOTIFY,
	EVENT_YUV_ROTATE_START_NOTIFY,
	EVENT_YUV_ROTATE_STOP_NOTIFY,
	EVENT_YUV_ROTATE_COMPLETE_NOTIFY,

	EVENT_AUD_ASR_INIT_NOTIFY,
	EVENT_AUD_ASR_DEINIT_NOTIFY,
	...
	EVENT_FRAME_BUFFER_MALLOC_IND = (FRAME_BUFFER_EVENT << MEDIA_EVT_BIT),
	EVENT_FRAME_BUFFER_PUSH_IND,
	EVENT_FRAME_BUFFER_FREE_IND,

	EVENT_AUD_ASR_CPU0_TO_CPU1_DATA_REQ = (AUD_ASR_TRS_EVENT << MEDIA_EVT_BIT),
	EVENT_AUD_ASR_CPU0_TO_CPU2_DATA_REQ,
	EVENT_AUD_ASR_CPU1_TO_CPU2_DATA_REQ,
	EVENT_AUD_ASR_CPU1_TO_CPU0_DATA_REQ,
	EVENT_AUD_ASR_CPU2_TO_CPU1_DATA_REQ,
	EVENT_AUD_ASR_CPU2_TO_CPU0_DATA_REQ,
