...
*/
bk_err_t adk_g711_encoder_test_case_0(void)
{
...
{"stream_in", "g711_enc", "stream_out"
    ...
    BK_LOGD(TAG, "--------- g711 encoder test complete: %s ----------\n", test_result ? "PASS" : "FAIL");
