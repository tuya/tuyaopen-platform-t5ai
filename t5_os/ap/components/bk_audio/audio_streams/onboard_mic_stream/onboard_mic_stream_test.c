...
/* The "onboard mic stream" element is a producer. The element is the first element.
   ...
   Function: Use onboard mic stream to record 10s audio data to uart.

   The "onboard mic stream" element write audio data to ringbuffer and record the data by uart.
*/
bk_err_t adk_onboard_mic_test_case_0(void)
{
    audio_pipeline_handle_t pipeline;
    audio_element_handle_t onboard_mic, uart_out;
