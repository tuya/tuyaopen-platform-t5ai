...
{
	BK_LOGD(NULL, "aud_ns_test {8000|16000|32000|48000 xxx.pcm xxx.pcm noise_value} \r\n");
}
...
//		addAON_GPIO_Reg0x8 = 2;
		ret = bk_aud_ns_process(in_addr);
//		addAON_GPIO_Reg0x8 = 0;
		if (ret == BK_FAIL) {
			BK_LOGD(NULL, "bk_aud_ns_process fail %d\r\n", ret);
			break;
		}
