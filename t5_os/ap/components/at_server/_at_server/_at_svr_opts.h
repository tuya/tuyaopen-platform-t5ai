...
#include "../../../include/components/log.h"

#ifndef ATSVR_VERSION_NUM
#define ATSVR_VERSION_NUM            "2.0"
#endif

#ifndef ATSVR_MAX_COMMANDS
#define ATSVR_MAX_COMMANDS           16
#endif
...
#define ATSVR_CMD_HELP_BUF_SIZE             (512)
#endif

#ifndef ATSVR_ECHO_DEFAULT
#define ATSVR_ECHO_DEFAULT                  ATSVR_ECHO_NORMAL
#endif
...
#ifndef ATSVR_CMD_NEW_VERSION_NOTIFY
#define ATSVR_CMD_NEW_VERSION_NOTIFY               "\r\nCMDRSP:Attention!You have input an old AT Cmd,please see the new AT format in BK IDK docs\r\n"
#endif
