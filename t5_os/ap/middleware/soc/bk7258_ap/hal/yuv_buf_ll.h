...
static inline void yuv_buf_ll_rencode_start(yuv_buf_hw_t *hw)
{
...
{
	hw->int_masks.int_vsync_nege_mask = mask;
}

static inline void yuv_buf_ll_int_resl_err_mask(yuv_buf_hw_t *hw, uint32_t mask)
{
	hw->int_masks.int_resl_err_mask = mask;
}

static inline void yuv_buf_ll_int_sens_full_mask(yuv_buf_hw_t *hw, uint32_t mask)
{
	hw->int_masks.int_sens_full_mask = mask;
}

static inline void yuv_buf_ll_int_enc_slow_mask(yuv_buf_hw_t *hw, uint32_t mask)
{
	hw->int_masks.int_enc_slow_mask = mask;
}

static inline void yuv_buf_ll_int_h264_err_mask(yuv_buf_hw_t *hw, uint32_t mask)
{
	hw->int_masks.int_h264_err_mask = mask;
}

static inline void yuv_buf_ll_set_emr_base_addr(yuv_buf_hw_t *hw, uint32_t resize_base_addr)
{
	hw->emr_base_addr = resize_base_addr;
}

static inline uint32_t yuv_buf_ll_get_emr_base_addr(yuv_buf_hw_t *hw)
{
	return hw->emr_base_addr;
}

static inline void yuv_buf_ll_set_x_pixel_resize(yuv_buf_hw_t *hw, uint32_t x_pixel_resize)
{
	hw->resize_pixel.x_pixel_resize = x_pixel_resize;
}

static inline void yuv_buf_ll_set_y_pixel_resize(yuv_buf_hw_t *hw, uint32_t y_pixel_resize)
{
	hw->resize_pixel.y_pixel_resize = y_pixel_resize;
}

static inline void yuv_buf_ll_enable_bps_pingpong(yuv_buf_hw_t *hw)
{
	hw->resize_pixel.bps_pingpong = 1;
}

static inline void yuv_buf_ll_disable_bps_pingpong(yuv_buf_hw_t *hw)
{
	hw->resize_pixel.bps_pingpong = 0;
}
