...
#define dma_hal_get_src_pause_addr(hal, id) dma_ll_get_src_pause_addr((hal)->hw, id)
#define dma_hal_get_dest_pause_addr(hal, id) dma_ll_get_dest_pause_addr((hal)->hw, id)
