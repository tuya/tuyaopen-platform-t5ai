...
static void i2s_isr_by_id(void);
...
bk_err_t bk_i2s_multi_driver_deinit(void)
{
	...
	if (s_i2s_driver_is_init)
	{
		I2S_LOGE("s_i2s_driver_is_init is %d, need call bk_i2s_deinit_by_id(0) first\r\n", s_i2s_driver_is_init);
		return BK_FAIL;
	}

	if (s_i2s1_driver_is_init)
	{
		I2S_LOGE("s_i2s1_driver_is_init is %d, need call bk_i2s_deinit_by_id(1) first\r\n", s_i2s1_driver_is_init);
		return BK_FAIL;
	}

	if (s_i2s2_driver_is_init)
	{
		I2S_LOGE("s_i2s2_driver_is_init is %d, need call bk_i2s_deinit_by_id(2) first\r\n", s_i2s2_driver_is_init);
		return BK_FAIL;
	}
...
bk_err_t bk_i2s_enable_by_id(i2s_gpio_group_id_t id, i2s_en_t en_value)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_en_set_by_id(id, en_value);
	return BK_OK;
}

bk_err_t bk_i2s_int_enable_by_id(i2s_gpio_group_id_t id, i2s_isr_id_t int_id, uint32_t value)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_int_set_by_id(id, int_id, value);
	return BK_OK;
}

bk_err_t bk_i2s_set_role_by_id(i2s_gpio_group_id_t id, i2s_role_t role)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_role_set_by_id(id, role);
	return BK_OK;
}

bk_err_t bk_i2s_set_work_mode_by_id(i2s_gpio_group_id_t id, i2s_work_mode_t work_mode)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_work_mode_set_by_id(id, work_mode);
	return BK_OK;
}

bk_err_t bk_i2s_set_lrck_invert_by_id(i2s_gpio_group_id_t id, i2s_lrck_invert_en_t lrckrp)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_lrck_invert_set_by_id(id, lrckrp);
	return BK_OK;
}

bk_err_t bk_i2s_set_sck_invert_by_id(i2s_gpio_group_id_t id, i2s_sck_invert_en_t sck_invert)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_sck_invert_set_by_id(id, sck_invert);
	return BK_OK;
}

bk_err_t bk_i2s_set_lsb_first_by_id(i2s_gpio_group_id_t id, i2s_lsb_first_en_t lsb_first)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_lsb_first_set_by_id(id, lsb_first);
	return BK_OK;
}

bk_err_t bk_i2s_set_sync_len_by_id(i2s_gpio_group_id_t id, uint32_t sync_len)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_sync_len_set_by_id(id, sync_len);
	return BK_OK;
}

bk_err_t bk_i2s_set_data_len_by_id(i2s_gpio_group_id_t id, uint32_t data_len)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_data_len_set_by_id(id, data_len);
	return BK_OK;
}

bk_err_t bk_i2s_set_pcm_dlen_by_id(i2s_gpio_group_id_t id, uint32_t pcm_dlen)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_pcm_dlen_set_by_id(id, pcm_dlen);
	return BK_OK;
}

bk_err_t bk_i2s_set_store_mode_by_id(i2s_gpio_group_id_t id, i2s_lrcom_store_mode_t store_mode)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_store_mode_set_by_id(id, store_mode);
	return BK_OK;
}

bk_err_t bk_i2s_clear_rxfifo_by_id(i2s_gpio_group_id_t id)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_rxfifo_clear_by_id(id);
	return BK_OK;
}

bk_err_t bk_i2s_clear_txfifo_by_id(i2s_gpio_group_id_t id)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_txfifo_clear_by_id(id);
	return BK_OK;
}

bk_err_t bk_i2s_clear_txudf_int_by_id(i2s_gpio_group_id_t id, i2s_channel_id_t channel_id)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_txudf_int_clear_by_id(id, channel_id);
	return BK_OK;
}

bk_err_t bk_i2s_clear_rxovf_int_by_id(i2s_gpio_group_id_t id, i2s_channel_id_t channel_id)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_rxovf_int_clear_by_id(id, channel_id);
	return BK_OK;
}

bk_err_t bk_i2s_set_txint_level_by_id(i2s_gpio_group_id_t id, i2s_txint_level_t txint_level)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_txint_level_set_by_id(id, txint_level);
	return BK_OK;
}

bk_err_t bk_i2s_set_rxint_level_by_id(i2s_gpio_group_id_t id, i2s_rxint_level_t rxint_level)
{
	uint8_t i2s_index = id;
	...
	i2s_hal_rxint_level_set_by_id(id, rxint_level);
	return BK_OK;
}

bk_err_t bk_i2s_write_data_by_id(i2s_gpio_group_id_t id, uint32_t channel_id, uint32_t *data_buf, uint32_t data_len)
{
	uint32_t i = 0;
	uint8_t i2s_index = id;
	...
	for (i=0; i<data_len; i++)
		i2s_hal_data_write_by_id(id, channel_id, data_buf[i]);
	return BK_OK;
}

bk_err_t bk_i2s_read_data_by_id(i2s_gpio_group_id_t id, uint32_t *data_buf, uint32_t data_len)
{
	uint32_t i = 0;
	uint8_t i2s_index = id;
	...
	for (i=0; i<data_len; i++)
		i2s_hal_data_read_by_id(id, &data_buf[i]);
	return BK_OK;
}

bk_err_t bk_i2s_get_data_addr_by_id(i2s_gpio_group_id_t id, i2s_channel_id_t chl_id, uint32_t *i2s_data_addr)
{
	uint8_t i2s_index = id;
...
bk_err_t bk_i2s_set_samp_rate_by_id(i2s_gpio_group_id_t id, i2s_samp_rate_t samp_rate)
{
	//SOC_I2S_APLL_RATE
	...
	if (smp_ratio > 0x1F) {
		i2s_hal_sample_ratio_set_by_id(id, smp_ratio & 0x1F);
		i2s_hal_sample_ratio_h2b_set_by_id(id, (smp_ratio >> 5) & 0x3);
	} else {
		i2s_hal_sample_ratio_set_by_id(id, smp_ratio);
	}
	if (bit_ratio > 0xFF) {
		i2s_hal_sck_ratio_set_by_id(id, bit_ratio & 0xFF);
		i2s_hal_sck_ratio_h4b_set_by_id(id, (bit_ratio >> 8) & 0xF);
	} else {
		i2s_hal_sck_ratio_set_by_id(id, bit_ratio);
	}
...
bk_err_t bk_i2s_register_i2s_isr_by_id(i2s_gpio_group_id_t id, i2s_isr_id_t isr_id, i2s_isr_t isr, void *param)
{
	uint32_t int_level;
...
static void i2s_isr_by_id(void)
{
	...
	bk_printf("i2s_isr_by_id: id: %d\n", id);

	i2s_status.channel_id = I2S_CHANNEL_1;
	i2s_hal_int_status_get_by_id(id, &i2s_status);
	...
	if (i2s_status.tx_udf) {
		i2s_hal_txudf_int_clear_by_id(id, I2S_CHANNEL_1);
	...
	if (i2s_status.rx_ovf) {
		i2s_hal_rxovf_int_clear_by_id(id, I2S_CHANNEL_1);
	...
	i2s_hal_int_status_get_by_id(id, &i2s_status);
	if (i2s_status.tx_udf) {
		i2s_hal_txudf_int_clear_by_id(id, I2S_CHANNEL_2);
	...
	if (i2s_status.rx_ovf) {
		i2s_hal_rxovf_int_clear_by_id(id, I2S_CHANNEL_2);
	...
	i2s_hal_int_status_get_by_id(id, &i2s_status);
	if (i2s_status.tx_udf) {
		i2s_hal_txudf_int_clear_by_id(id, I2S_CHANNEL_3);
	...
	if (i2s_status.rx_ovf) {
		i2s_hal_rxovf_int_clear_by_id(id, I2S_CHANNEL_3);
...
static void i2s0_chl1_tx_dma_finish_isr(void)
{
	i2s_drv_info_t *drv_info = NULL;
	uint8_t i2s_index = I2S_GPIO_GROUP_0;
...
static void i2s1_chl1_tx_dma_finish_isr(void)
{
	i2s_drv_info_t *drv_info = NULL;
	uint8_t i2s_index = I2S_GPIO_GROUP_1;
...
static void i2s2_chl1_tx_dma_finish_isr(void)
{
	i2s_drv_info_t *drv_info = NULL;
	uint8_t i2s_index = I2S_GPIO_GROUP_2;
...
/* i2s channel 1 rx dma isr handle */
static void i2s0_chl1_rx_dma_finish_isr(void)
{
	i2s_drv_info_t *drv_info = NULL;
	uint8_t i2s_index = I2S_GPIO_GROUP_0;
...
static void i2s1_chl1_rx_dma_finish_isr(void)
{
	i2s_drv_info_t *drv_info = NULL;
	uint8_t i2s_index = I2S_GPIO_GROUP_1;
...
static void i2s2_chl1_rx_dma_finish_isr(void)
{
	i2s_drv_info_t *drv_info = NULL;
	uint8_t i2s_index = I2S_GPIO_GROUP_2;
...
static void i2s_chl2_by_id_tx_dma_finish_isr(void)
{
	i2s_drv_info_t *drv_info = NULL;
	uint8_t i2s_index = 0;
...
/* i2s channel 2 tx dma isr handle */
static void i2s_chl2_by_id_rx_dma_finish_isr(void)
{
	i2s_drv_info_t *drv_info = NULL;
	uint8_t i2s_index = 0;
...
static void i2s_chl3_by_id_tx_dma_finish_isr(void)
{
	i2s_drv_info_t *drv_info = NULL;
	uint8_t i2s_index = 0;
...
/* i2s channel 3 tx dma isr handle */
static void i2s_chl3_by_id_rx_dma_finish_isr(void)
{
	i2s_drv_info_t *drv_info = NULL;
	uint8_t i2s_index = 0;
...
static bk_err_t i2s_dma_config_by_id(i2s_gpio_group_id_t id, dma_id_t dma_id, uint32_t *ring_buff_addr, uint32_t ring_buff_size, uint32_t transfer_len, i2s_channel_id_t chl_id, i2s_txrx_type_t type, i2s_data_handle_cb data_handle_cb)
{
	bk_err_t ret = BK_OK;
	...
	/* get i2s address */
	bk_i2s_get_data_addr_by_id(id, chl_id, &i2s_data_addr);
		...
		switch (chl_id) {
			case I2S_CHANNEL_1:
				if (type == I2S_TXRX_TYPE_TX){
					if (id == 0) {
						bk_dma_register_isr(dma_id, NULL, (void *)i2s0_chl1_tx_dma_finish_isr);
					} else if (id == 1) {
						bk_dma_register_isr(dma_id, NULL, (void *)i2s1_chl1_tx_dma_finish_isr);
					} else if (id == 2) {
						bk_dma_register_isr(dma_id, NULL, (void *)i2s2_chl1_tx_dma_finish_isr);
					}
				}
				else{
					if (id == 0) {
						bk_dma_register_isr(dma_id, NULL, (void *)i2s0_chl1_rx_dma_finish_isr);
					} else if (id == 1) {
						bk_dma_register_isr(dma_id, NULL, (void *)i2s1_chl1_rx_dma_finish_isr);
					} else if (id == 2) {
						bk_dma_register_isr(dma_id, NULL, (void *)i2s2_chl1_rx_dma_finish_isr);
					}
				}
				break;
			case I2S_CHANNEL_2:
				if (type == I2S_TXRX_TYPE_TX){
					bk_dma_register_isr(dma_id, NULL, (void *)i2s_chl2_by_id_tx_dma_finish_isr);
				}
				else{
					bk_dma_register_isr(dma_id, NULL, (void *)i2s_chl2_by_id_rx_dma_finish_isr);
				}
				break;
			case I2S_CHANNEL_3:
				if (type == I2S_TXRX_TYPE_TX){
					bk_dma_register_isr(dma_id, NULL, (void *)i2s_chl3_by_id_tx_dma_finish_isr);
				}
				else{
					bk_dma_register_isr(dma_id, NULL, (void *)i2s_chl3_by_id_rx_dma_finish_isr);
				}
				break;
			default:
				break;
...
bk_err_t bk_i2s_init_by_id(i2s_gpio_group_id_t id, const i2s_config_t *config)
{
	...
	switch (id) {
		case I2S_GPIO_GROUP_0:
			...
			i2s_hal_soft_reset_by_id(id);
			sys_drv_i2s_int_en(1);
			os_memset(&s_i2s_isr, 0, sizeof(s_i2s_isr));
			int_config_table.int_src = INT_SRC_I2S0;
			int_config_table.isr = i2s_isr_by_id;
	...
	i2s_hal_config_by_id(id, &(drv_info->config));

	if (bk_i2s_set_samp_rate_by_id(id, drv_info->config.samp_rate) != BK_OK) {
...
bk_err_t bk_i2s_deinit_by_id(i2s_gpio_group_id_t id)
{
	...
	if (id == 0) {
		...
		drv_info = i2s_drv_info;
        i2s_drv_info = NULL;
		s_i2s_driver_is_init = 0;
	} else if (id == 1) {
		I2S1_RETURN_ON_NOT_INIT();
		drv_info = i2s1_drv_info;
        i2s1_drv_info = NULL;
		s_i2s1_driver_is_init = 0;
	} else if (id == 2) {
		I2S2_RETURN_ON_NOT_INIT();
		drv_info = i2s2_drv_info;
        i2s2_drv_info = NULL;
		s_i2s2_driver_is_init = 0;
	} else {
		return BK_FAIL;
	}

	i2s_hal_deconfig_by_id(id);

	if (drv_info->chl1_cfg) {
		bk_i2s_chl_deinit_by_id(id, I2S_CHANNEL_1, I2S_TXRX_TYPE_TX);
		bk_i2s_chl_deinit_by_id(id,I2S_CHANNEL_1, I2S_TXRX_TYPE_RX);
	}

	if (drv_info->chl2_cfg) {
		bk_i2s_chl_deinit_by_id(id, I2S_CHANNEL_2, I2S_TXRX_TYPE_TX);
		bk_i2s_chl_deinit_by_id(id, I2S_CHANNEL_2, I2S_TXRX_TYPE_RX);
	}

	if (drv_info->chl3_cfg) {
		bk_i2s_chl_deinit_by_id(id, I2S_CHANNEL_3, I2S_TXRX_TYPE_TX);
		bk_i2s_chl_deinit_by_id(id, I2S_CHANNEL_3, I2S_TXRX_TYPE_RX);
	}
...
bk_err_t bk_i2s_start_by_id(i2s_gpio_group_id_t id)
{
	...
	/* first enable i2s */
	bk_i2s_enable_by_id(id, I2S_ENABLE);
	...
	switch (drv_info->config.work_mode) {
		...
		case I2S_WORK_MODE_LEFTJUST:
		case I2S_WORK_MODE_RIGHTJUST:
			bk_i2s_write_data_by_id(id, I2S_CHANNEL_2, &temp_data, 1);
			bk_i2s_write_data_by_id(id, I2S_CHANNEL_3, &temp_data, 1);
			break;
...
bk_err_t bk_i2s_stop_by_id(i2s_gpio_group_id_t id)
{
	...
	bk_i2s_enable_by_id(id, I2S_DISABLE);
...
bk_err_t bk_i2s_chl_init_by_id(i2s_gpio_group_id_t id, i2s_channel_id_t chl, i2s_txrx_type_t type, uint32_t buff_size, i2s_data_handle_cb data_handle_cb, RingBufferContext **rb)
{
	...
	bk_printf("bk_i2s_chl_init_by_id: id: %d, chl: %d, type: %d, buff_size: %d, data_handle_cb: %p, rb: %p drv_info: %p\n", id, chl, type, buff_size, data_handle_cb, rb, drv_info);
	
	switch (chl) {
		case I2S_CHANNEL_1:
				if (drv_info->chl1_cfg == NULL) {
					drv_info->chl1_cfg = (i2s_chl_cfg_t *)os_malloc(sizeof(i2s_chl_cfg_t));
					if (drv_info->chl1_cfg == NULL) {
				...
				if (type == I2S_TXRX_TYPE_TX) {
					drv_info->chl1_cfg->tx_cfg = (i2s_txrx_cfg_t *)os_malloc(sizeof(i2s_txrx_cfg_t));
					...
					drv_info->chl1_cfg->tx_cfg->rb = (RingBufferContext *)os_malloc(sizeof(RingBufferContext));
					...
					*rb = drv_info->chl1_cfg->tx_cfg->rb;
					...
					switch (id) {
						case 0:
							...
							break;
						case 1:
							drv_info->chl1_cfg->tx_cfg->dma_id = bk_dma_alloc(DMA_DEV_I2S1);
							break;
						case 2:
							drv_info->chl1_cfg->tx_cfg->dma_id = bk_dma_alloc(DMA_DEV_I2S2);
							break;
						case 3:
							break;
					}
					bk_printf("tx i2s id: %d, dma_id: %d\n", id, drv_info->chl1_cfg->tx_cfg->dma_id);
					// drv_info->chl1_cfg->tx_cfg->dma_id = bk_dma_alloc(DMA_DEV_I2S);
					...
					ret = i2s_dma_config_by_id(id, drv_info->chl1_cfg->tx_cfg->dma_id, (uint32_t *)drv_info->chl1_cfg->tx_cfg->buff_addr, buff_size + DMA_CARRY_I2S_RINGBUF_SAFE_INTERVAL, buff_size/2, chl, type, data_handle_cb);
					if (ret != BK_OK) {
					...
					drv_info->chl1_cfg->rx_cfg = (i2s_txrx_cfg_t *)os_malloc(sizeof(i2s_txrx_cfg_t));
					...
					drv_info->chl1_cfg->rx_cfg->buff_addr = (uint8_t *)os_malloc(buff_size);
					if (drv_info->chl1_cfg->rx_cfg->buff_addr == NULL) {
						I2S_LOGE("malloc buff_addr fail \n");
						err = BK_FAIL;
						return err;
					}
					drv_info->chl1_cfg->rx_cfg->rb = (RingBufferContext *)os_malloc(sizeof(RingBufferContext));
					...
					*rb = drv_info->chl1_cfg->rx_cfg->rb;
					...
					switch (id) {
						case 0:
							drv_info->chl1_cfg->rx_cfg->dma_id = bk_dma_alloc(DMA_DEV_I2S_RX);
							break;
						case 1:
							drv_info->chl1_cfg->rx_cfg->dma_id = bk_dma_alloc(DMA_DEV_I2S1_RX);
							break;
						case 2:
							drv_info->chl1_cfg->rx_cfg->dma_id = bk_dma_alloc(DMA_DEV_I2S2_RX);
							break;
						case 3:
							break;
					}
					bk_printf("rx i2s id: %d, dma_id: %d\n", id, drv_info->chl1_cfg->rx_cfg->dma_id);
					// drv_info->chl1_cfg->rx_cfg->dma_id = bk_dma_alloc(DMA_DEV_I2S_RX);
					...
					ret = i2s_dma_config_by_id(id, drv_info->chl1_cfg->rx_cfg->dma_id, (uint32_t *)drv_info->chl1_cfg->rx_cfg->buff_addr, buff_size, buff_size/2, chl, type, data_handle_cb);
					if (ret != BK_OK) {
						I2S_LOGE("dma config fail \r\n");
						err = BK_FAIL;
						return err;
		...
		case I2S_CHANNEL_2:
				if (drv_info->chl2_cfg == NULL) {
					drv_info->chl2_cfg = (i2s_chl_cfg_t *)os_malloc(sizeof(i2s_chl_cfg_t));
					if (drv_info->chl2_cfg == NULL) {
				...
				if (type == I2S_TXRX_TYPE_TX) {
					drv_info->chl2_cfg->tx_cfg = (i2s_txrx_cfg_t *)os_malloc(sizeof(i2s_txrx_cfg_t));
					...
					drv_info->chl2_cfg->tx_cfg->rb = (RingBufferContext *)os_malloc(sizeof(RingBufferContext));
					...
					*rb = drv_info->chl2_cfg->tx_cfg->rb;
					...
					ret = i2s_dma_config_by_id(id, drv_info->chl2_cfg->tx_cfg->dma_id, (uint32_t *)drv_info->chl2_cfg->tx_cfg->buff_addr, buff_size + DMA_CARRY_I2S_RINGBUF_SAFE_INTERVAL, buff_size/2, chl, type, data_handle_cb);
					if (ret != BK_OK) {
						I2S_LOGE("dma config fail \r\n");
						err = BK_FAIL;
						return err;
					...
					drv_info->chl2_cfg->rx_cfg = (i2s_txrx_cfg_t *)os_malloc(sizeof(i2s_txrx_cfg_t));
					...
					drv_info->chl2_cfg->rx_cfg->rb = (RingBufferContext *)os_malloc(sizeof(RingBufferContext));
					...
					*rb = drv_info->chl2_cfg->rx_cfg->rb;
					...
					/* allocate free DMA channel */
					drv_info->chl2_cfg->rx_cfg->dma_id = bk_dma_alloc(DMA_DEV_I2S_RX);
					...
					ret = i2s_dma_config_by_id(id, drv_info->chl2_cfg->rx_cfg->dma_id, (uint32_t *)drv_info->chl2_cfg->rx_cfg->buff_addr, buff_size + DMA_CARRY_I2S_RINGBUF_SAFE_INTERVAL, buff_size/2, chl, type, data_handle_cb);
					if (ret != BK_OK) {
						I2S_LOGE("dma config fail \r\n");
						err = BK_FAIL;
						return err;
		...
		case I2S_CHANNEL_3:
				if (drv_info->chl3_cfg == NULL) {
					drv_info->chl3_cfg = (i2s_chl_cfg_t *)os_malloc(sizeof(i2s_chl_cfg_t));
					if (drv_info->chl3_cfg == NULL) {
						I2S_LOGE("malloc chl1_cfg fail \n");
						err = BK_FAIL;
						return err;
				...
				if (type == I2S_TXRX_TYPE_TX) {
					drv_info->chl3_cfg->tx_cfg = (i2s_txrx_cfg_t *)os_malloc(sizeof(i2s_txrx_cfg_t));
					...
					drv_info->chl3_cfg->tx_cfg->rb = (RingBufferContext *)os_malloc(sizeof(RingBufferContext));
					...
					*rb = drv_info->chl3_cfg->tx_cfg->rb;
					...
					ret = i2s_dma_config_by_id(id, drv_info->chl3_cfg->tx_cfg->dma_id, (uint32_t *)drv_info->chl3_cfg->tx_cfg->buff_addr, buff_size + DMA_CARRY_I2S_RINGBUF_SAFE_INTERVAL, buff_size/2, chl, type, data_handle_cb);
					if (ret != BK_OK) {
						I2S_LOGE("dma config fail \r\n");
						err = BK_FAIL;
						return err;
					...
					drv_info->chl3_cfg->rx_cfg = (i2s_txrx_cfg_t *)os_malloc(sizeof(i2s_txrx_cfg_t));
					...
					drv_info->chl3_cfg->rx_cfg->rb = (RingBufferContext *)os_malloc(sizeof(RingBufferContext));
					...
					*rb = drv_info->chl3_cfg->rx_cfg->rb;
					...
					ret = i2s_dma_config_by_id(id, drv_info->chl3_cfg->rx_cfg->dma_id, (uint32_t *)drv_info->chl3_cfg->rx_cfg->buff_addr, buff_size + DMA_CARRY_I2S_RINGBUF_SAFE_INTERVAL, buff_size/2, chl, type, data_handle_cb);
					if (ret != BK_OK) {
						I2S_LOGE("dma config fail \r\n");
						err = BK_FAIL;
						return err;
			...
			if (type == I2S_TXRX_TYPE_TX) {
				if (drv_info->chl1_cfg && drv_info->chl1_cfg->tx_cfg) {
					...
					if (drv_info->chl1_cfg->tx_cfg->rb)
						os_free(drv_info->chl1_cfg->tx_cfg->rb);
					drv_info->chl1_cfg->tx_cfg->rb = NULL;
					if (drv_info->chl1_cfg->tx_cfg->buff_addr)
						os_free(drv_info->chl1_cfg->tx_cfg->buff_addr);
					drv_info->chl1_cfg->tx_cfg->buff_addr = NULL;
					drv_info->chl1_cfg->tx_cfg->buff_size = 0;
					drv_info->chl1_cfg->tx_cfg->dma_id = DMA_ID_MAX;
					drv_info->chl1_cfg->tx_cfg->state = I2S_TXRX_STATE_NULL;
					...
					if (drv_info->chl1_cfg->tx_cfg)
						os_free(drv_info->chl1_cfg->tx_cfg);
					drv_info->chl1_cfg->tx_cfg = NULL;
				}
			} else {
				if (drv_info->chl1_cfg && drv_info->chl1_cfg->rx_cfg) {
					...
					if (drv_info->chl1_cfg->rx_cfg->rb)
						os_free(drv_info->chl1_cfg->rx_cfg->rb);
					drv_info->chl1_cfg->rx_cfg->rb = NULL;
					if (drv_info->chl1_cfg->rx_cfg->buff_addr)
						os_free(drv_info->chl1_cfg->rx_cfg->buff_addr);
					drv_info->chl1_cfg->rx_cfg->buff_addr = NULL;
					drv_info->chl1_cfg->rx_cfg->buff_size = 0;
					drv_info->chl1_cfg->rx_cfg->dma_id = DMA_ID_MAX;
					drv_info->chl1_cfg->rx_cfg->state = I2S_TXRX_STATE_NULL;
			...
			if (type == I2S_TXRX_TYPE_TX) {
				if (drv_info->chl2_cfg && drv_info->chl2_cfg->tx_cfg) {
					...
					if (drv_info->chl2_cfg->tx_cfg->rb)
						os_free(drv_info->chl2_cfg->tx_cfg->rb);
					drv_info->chl2_cfg->tx_cfg->rb = NULL;
					if (drv_info->chl2_cfg->tx_cfg->buff_addr)
						os_free(drv_info->chl2_cfg->tx_cfg->buff_addr);
					drv_info->chl2_cfg->tx_cfg->buff_addr = NULL;
					drv_info->chl2_cfg->tx_cfg->buff_size = 0;
					drv_info->chl2_cfg->tx_cfg->dma_id = DMA_ID_MAX;
					drv_info->chl2_cfg->tx_cfg->state = I2S_TXRX_STATE_NULL;
					...
					if (drv_info->chl2_cfg->tx_cfg)
						os_free(drv_info->chl2_cfg->tx_cfg);
					drv_info->chl2_cfg->tx_cfg = NULL;
				}
			} else {
				if (drv_info->chl2_cfg && drv_info->chl2_cfg->rx_cfg) {
					...
					if (drv_info->chl2_cfg->rx_cfg->rb)
						os_free(drv_info->chl2_cfg->rx_cfg->rb);
					drv_info->chl2_cfg->rx_cfg->rb = NULL;
					if (drv_info->chl2_cfg->rx_cfg->buff_addr)
						os_free(drv_info->chl2_cfg->rx_cfg->buff_addr);
					drv_info->chl2_cfg->rx_cfg->buff_addr = NULL;
					drv_info->chl2_cfg->rx_cfg->buff_size = 0;
					drv_info->chl2_cfg->rx_cfg->dma_id = DMA_ID_MAX;
					drv_info->chl2_cfg->rx_cfg->state = I2S_TXRX_STATE_NULL;
			...
			if (type == I2S_TXRX_TYPE_TX) {
				if (drv_info->chl3_cfg && drv_info->chl3_cfg->tx_cfg) {
					...
					if (drv_info->chl3_cfg->tx_cfg->rb)
						os_free(drv_info->chl3_cfg->tx_cfg->rb);
					drv_info->chl3_cfg->tx_cfg->rb = NULL;
					if (drv_info->chl3_cfg->tx_cfg->buff_addr)
						os_free(drv_info->chl3_cfg->tx_cfg->buff_addr);
					drv_info->chl3_cfg->tx_cfg->buff_addr = NULL;
					drv_info->chl3_cfg->tx_cfg->buff_size = 0;
					drv_info->chl3_cfg->tx_cfg->dma_id = DMA_ID_MAX;
					drv_info->chl3_cfg->tx_cfg->state = I2S_TXRX_STATE_NULL;
					...
					if (drv_info->chl3_cfg->tx_cfg)
						os_free(drv_info->chl3_cfg->tx_cfg);
					drv_info->chl3_cfg->tx_cfg = NULL;
				}
			} else {
				if (drv_info->chl3_cfg && drv_info->chl3_cfg->rx_cfg) {
					...
					if (drv_info->chl3_cfg->rx_cfg->rb)
						os_free(drv_info->chl3_cfg->rx_cfg->rb);
					drv_info->chl3_cfg->rx_cfg->rb = NULL;
					if (drv_info->chl3_cfg->rx_cfg->buff_addr)
						os_free(drv_info->chl3_cfg->rx_cfg->buff_addr);
					drv_info->chl3_cfg->rx_cfg->buff_addr = NULL;
					drv_info->chl3_cfg->rx_cfg->buff_size = 0;
					drv_info->chl3_cfg->rx_cfg->dma_id = DMA_ID_MAX;
					drv_info->chl3_cfg->rx_cfg->state = I2S_TXRX_STATE_NULL;
...
bk_err_t bk_i2s_get_read_ready_by_id(i2s_channel_id_t channel_id, uint32_t *read_flag)
{
	return i2s_hal_read_ready_get_by_id(channel_id,read_flag);
}

bk_err_t bk_i2s_get_write_ready_by_id(i2s_channel_id_t channel_id, uint32_t *write_flag)
{
	return i2s_hal_write_ready_get_by_id(channel_id, write_flag);
}