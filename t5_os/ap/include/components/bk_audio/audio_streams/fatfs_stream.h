...
#define FATFS_STREAM_OUT_BLOCK_SIZE      (2 * 1024)
#define FATFS_STREAM_OUT_BLOCK_NUM       (1)


#define FATFS_STREAM_CFG_DEFAULT() {                    \
        .type = AUDIO_STREAM_NONE,                      \
        .buf_sz = FATFS_STREAM_BUF_SIZE,                \
        .out_block_size = FATFS_STREAM_OUT_BLOCK_SIZE,  \
        .out_block_num = FATFS_STREAM_OUT_BLOCK_NUM,    \
