 ...
 *
 * cp2 wakeup source config
 *
 * @attention
 * - This API is used to cp2 wakeup source config
 *
 * @param
 * - sleep_mode:sleep mode
 * - wakeup_source: wakeup source
 * - gpio_wakeup_cfg
 * @return
 * - BK_OK: succeed
 * - others: other errors.
...
/**
 * @brief rtc wakeup source config
 *
 * cp2 wakeup source config
 *
 * @attention
...
/**
 * @brief cp2 rtc enter deepsleep
 *
 * cp2 rtc enter deepsleep
 *
 * @attention
 * - This API is used to cp2 rtc enter deepsleep
 *
 * @param
 * - module:module name
 * - sleep_time: sleep time(unit:ms)
 * @return
 * - BK_OK: succeed
 * - others: other errors.
 *
...
/**
 * @brief cpu1 send cpu0 info through mailbox
 *
 * cpu1 send cpu0 info through mailbox
 *
 * @attention
 * - This API is used cpu1 send cpu0 info through mailbox
 *
 * @param
 * -cmd: command
 * -param1
