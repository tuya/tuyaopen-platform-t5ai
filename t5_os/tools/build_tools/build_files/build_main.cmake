...
if(DEFINED ENV{USE_LIBS_DETERMINED_MODE})
    # Set the AR mode to deterministic mode, so that static libraries generated by the same code in the same path are determined.
    ...
    # Substitute absolute path of sdk(idk, avdk, etc) with default path.
    if(DEFINED ENV{ARMINO_USE_WRAPPER})
        set(MAP_OLD_PATH $ENV{ARMINO_WRAPPER_PATH})
        set(MAP_NEW_PATH $ENV{ARMINO_WRAPPER_NEW_PATH})
    else()
        set(MAP_OLD_PATH $ENV{ARMINO_PATH})
        set(MAP_NEW_PATH /armino)
    endif()
    list(APPEND compile_options "-fdebug-prefix-map=${MAP_OLD_PATH}=${MAP_NEW_PATH}")
endif()
