...
function(armino_build_get_property var property)
    ...
    if(__GENERATOR_EXPRESSION)
        message(FATAL_ERROR "Getting build property generator expression not
                supported before armino_component_register().")
    endif()
...
include(${armino_tools_path}/build_tools/cmake/utilities.cmake)
...
macro(require_armino_targets)
endmacro()

macro(armino_component_register)
    set(options)
...
macro(armino_component_register_ex)
    set(options)
...
armino_build_get_property(__common_reqs __COMPONENT_REQUIRES_COMMON)
armino_build_get_property(__component_targets __COMPONENT_TARGETS)
