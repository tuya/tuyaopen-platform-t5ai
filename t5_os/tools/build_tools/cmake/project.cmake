...
macro(project project_name)
    ...
    set(T5_CP "bk7258")
    set(T5_AP "bk7258_ap")
    if ("${ARMINO_SOC}" STREQUAL T5_AP)
        LOGI("Building Beken ARMINO components for target T5 AP")
    elseif("${ARMINO_SOC}" STREQUAL T5_CP)
        LOGI("Building Beken ARMINO components for target T5 CP")
    endif()
